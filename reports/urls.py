...
# Public reporting endpoints for creating and viewing user-owned reports.
urlpatterns = [
    ...
    # Admin dashboard and moderation endpoints for review workflows.
    ...
    path(
        "my_reports/<int:report_id>/",
        views.my_report_detail,
    ...
    path(
        "admin/comment/<int:report_id>/",
        views.add_report_comment,
        name="add_report_comment",
    ),

    # Reporting and map-related viewing endpoints.
